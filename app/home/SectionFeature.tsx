...
const SectionFeature = () => {
  return (
    <motion.div className='mt-20 flex aspect-video w-full flex-col'>
      <h1 className='text-2xl font-bold text-emerald-500'>Fitur</h1>
      <h2 className='mt-3 text-5xl font-bold leading-snug'>Keunggulan Bikinsoal.com<br />Antara Lain:</h2>
